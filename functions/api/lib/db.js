...
const DEFAULT_SPONSORS = [
  {
    ...
    subtitle: 'Importadora em Groningen focada em produtos tropicais e amazônicos.',
    url: 'https://globalfoodimport.com/',
    sortOrder: 1,
  },
  {
    name: 'Tribe Açaí',
    subtitle: 'Açaí e sorbets naturais com identidade amazônica e pegada premium.',
    url: 'https://www.tribeacai.com/',
    sortOrder: 2,
  },
  {
    name: 'Ramos Klus & Schoonmaak',
    subtitle: 'Serviços locais de manutenção e limpeza apoiando a comunidade.',
    url: 'https://www.google.com/search?q=Ramos+Klus+%26+Schoonmaak+Groningen',
    sortOrder: 3,
  },
];
